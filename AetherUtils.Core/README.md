...
I found that I was always copying most of the same boilerplate code between projects of mine, so I decided that a
single,
Nuget package would be better. That way, it can just be installed into the project to access all the helper code.

As you can tell from below, this utility package contains quite a bit of functionality; there is more than what's listed
here.
